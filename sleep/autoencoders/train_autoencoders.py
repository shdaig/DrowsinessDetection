...
from drowsiness.ml.autoencoders import channelconvnet_512
from drowsiness.ml.autoencoders import channelconvnet_latent56_filters64
from drowsiness.ml.autoencoders import channelconvnet_latent56_filters128
from drowsiness.ml.autoencoders import channelconvnet_1536
from drowsiness.ml.autoencoders import channelconvnet_fc_500
...
if __name__ == "__main__":
    with tf.device('/GPU:1'):
        ...
        # ae_types = ["channelconvnet_latent56_filters64", "channelconvnet_latent56_filters128"]
        ae_types = ["channelconvnet_latent56_filters64"]
        ...
        for ae_type in ae_types:
            ...
            for test_file in subject_files:
                ...
                autoencoder = None
                if ae_type == "channelconvnet_168":
                    autoencoder = channelconvnet_168.DeepConvNetAutoencoder()
                elif ae_type == "channelconvnet_512":
                    autoencoder = channelconvnet_512.DeepConvNetAutoencoder()
                elif ae_type == "channelconvnet_1536":
                    autoencoder = channelconvnet_1536.DeepConvNetAutoencoder()
                elif ae_type == "channelconvnet_latent56_filters64":
                    autoencoder = channelconvnet_latent56_filters64.DeepConvNetAutoencoder()
                elif ae_type == "channelconvnet_latent56_filters128":
                    autoencoder = channelconvnet_latent56_filters128.DeepConvNetAutoencoder()
                elif ae_type == "channelconvnet_fc_500":
                    autoencoder = channelconvnet_fc_500.DeepConvNetAutoencoder()

                autoencoder.compile(optimizer=keras.optimizers.Adam(learning_rate=1e-4), loss=losses.MeanSquaredError())
                start = time.time()
